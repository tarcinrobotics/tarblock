/*
TrueType to Adafruit_GFXx font converter.  Derived from Peter Jakobs'
Adafruit_ftGFX fork & makefont tool, and Paul Kourany's Adafruit_mfGFX.

NOT AN ARDUINO SKETCH.  This is a command-line tool for preprocessing
fonts to be used with the Adafruit_GFXx Arduino library.
...
#include <ft2build.h>
#include FT_GLYPH_H
#include "../gfxfont.h" // Adafruit_GFXx font structures
...
fonts (classic fonts unchanged).  See Adafruit_GFXx.cpp for explanation.
*/
