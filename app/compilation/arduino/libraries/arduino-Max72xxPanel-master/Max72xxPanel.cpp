/******************************************************************
 ...
 You need to download and install Adafruit_GFXx to use this library.
...
Max72xxPanel::Max72xxPanel(byte csPin, byte hDisplays, byte vDisplays) : Adafruit_GFXx(hDisplays << 3, vDisplays << 3) {
...
void Max72xxPanel::setRotation(uint8_t rotation) {
	Adafruit_GFXx::setRotation(rotation);
}
