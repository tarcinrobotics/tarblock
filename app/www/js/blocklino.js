...
BlocklyDuino.workspace_capture = function() {
	...
	xml = '<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="'+bbox.width+'" height="'+bbox.height+'" viewBox="' + bbox.x + ' ' + bbox.y + ' '  + bbox.width + ' ' + bbox.height + '"><rect width="10%" height="10%" fill="white"></rect>'+xml+'</svg>';
	var img = new Image();
